...
#define CONDUCT                 (1<<9)   // Conducts electricity. (metal etc.)
...
#define STOPPRESSUREDAMAGE      (1<<6)  // Counts towards pressure protection. Note that like temperature protection, body_parts_covered is considered here as well.
