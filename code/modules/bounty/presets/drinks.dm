...
/datum/bounty/drinks/doorsprint_07
	...
	reagents_wanted = list("mintjulep" = 400)
...
/datum/bounty/drinks/doorsprint_08
	name = "DoorSprint Order: Stress Free"
	author = "Amy Amelia Amisdottir"
	...
	reagents_wanted = list("cloverclub" = 400)
...
/datum/bounty/drinks/doorsprint_09
	name = "DoorSprint Order: I'll Live Forever, Why Won't You Too?"
	author = "Rue Cole"
	...
	reagents_wanted = list("euphoria" = 500)
...
/datum/bounty/drinks/doorsprint_10
	name = "DoorSprint Order: Whatcha Drinkin'?"
	author = "Walton Oreole"
	...
	reagents_wanted = list("margarita" = 400)
...
/datum/bounty/drinks/doorsprint_11
	...
	reagents_wanted = list("rotgut" = 400)
...
/datum/bounty/drinks/doorsprint_12
	...
	reagents_wanted = list("tokyorose" = 500)
...
/datum/bounty/drinks/doorsprint_13
	...
	reagents_wanted = list("xanaducannon" = 500)
...
/datum/bounty/drinks/doorsprint_14
	...
	reagents_wanted = list("chrysanthemum" = 600)
...
/datum/bounty/drinks/doorsprint_15
	...
	reagents_wanted = list("lovepotion" = 500)
...
/datum/bounty/drinks/doorsprint_16 //love letter to the vox - this doesn't mean they are canon
	...
	reagents_wanted = list("icecoffee" = 300)
...
/datum/bounty/drinks/doorsprint_17
	name = "Tall and Dark"
	author = "Madam Louisville"
	description = "Coffee, naturally."

	reagents_wanted = list("coffee" = 500)
