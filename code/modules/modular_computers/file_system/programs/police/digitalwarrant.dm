...
/datum/computer_file/program/digitalwarrant/proc/print_warrant(mob/user)
	...
	if(activewarrant.fields["arrestsearch"] == "arrest")
		...
		<BODY bgcolor='#FFFFFF'><center><large><b>Kiel City Police Department Bureau</b></large></br>
		...
		Area of Warrant: _<u>Kiel City</u>____</br>
	...
	if(activewarrant.fields["arrestsearch"] == "search")
		...
		Location: _<u>Kiel City</u>____</br>
		</BODY></HTML>
		"}
