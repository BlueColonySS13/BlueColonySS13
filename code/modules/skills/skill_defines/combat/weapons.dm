...
//weapons
/datum/category_item/skill/combat/weapons
	id = SKILL_WEAPONS
	...
	levels = list(
		/datum/skill_level/weapons/zero,
		/datum/skill_level/weapons/one,
		/datum/skill_level/weapons/two,
		/datum/skill_level/weapons/three
		)
