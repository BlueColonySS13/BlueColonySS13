...
//close combat
/datum/category_item/skill/combat/close_combat
	...
	levels = list(
		/datum/skill_level/close_combat/zero,
		/datum/skill_level/close_combat/one,
		/datum/skill_level/close_combat/two,
		/datum/skill_level/close_combat/three
		)
