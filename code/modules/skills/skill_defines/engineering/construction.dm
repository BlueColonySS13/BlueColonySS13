...
//construction
/datum/category_item/skill/construction/construction
	id = SKILL_CONSTRUCTION
	name = "Construction Expertise"
	...
	levels = list(
		/datum/skill_level/construction/zero,
		/datum/skill_level/construction/one,
		/datum/skill_level/construction/two,
		/datum/skill_level/construction/three
		)
