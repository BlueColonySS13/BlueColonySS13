...
//crafting
/datum/category_item/skill/general/crafting
	id = SKILL_crafting
	name = "crafting"
	...
	levels = list(
		/datum/skill_level/crafting/zero,
		/datum/skill_level/crafting/one,
		/datum/skill_level/crafting/two,
		/datum/skill_level/crafting/three
		)
