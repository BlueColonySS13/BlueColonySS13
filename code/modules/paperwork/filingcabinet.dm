...
/obj/structure/filingcabinet/security/proc/populate()
	if(virgin)
		for(var/datum/data/record/G in data_core.general)
			...
			P.info += "<BR>\n<CENTER><B>Security Data</B></CENTER><BR>\nCriminal Status: [S.fields["criminal"]]<BR>\n<BR>\nPrevious Convictions: [S.fields["pre_con"]]<BR>\nDetails: [S.fields["pre_con_d"]]<BR>\n<BR>\nWarnings: [S.fields["warn"]]<BR>\nDetails: [S.fields["warn_d"]]<BR>\n<BR>\nInjunctions: [S.fields["injunc"]]<BR>\nDetails: [S.fields["injunc_d"]]<BR>\n<BR>\nImportant Notes:<BR>\n\t[S.fields["notes"]]<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>"
			var/counter = 1
