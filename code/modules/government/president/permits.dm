...
/datum/persistent_option/portal/number_value/permit
	min_value = 0
	max_value = 50000

// Gun Permits
/datum/persistent_option/portal/number_value/permit/gun/tier_0
...
/datum/persistent_option/portal/number_value/permit/gun/tier_1
...
/datum/persistent_option/portal/number_value/permit/gun/tier_2
...
/datum/persistent_option/portal/number_value/permit/gun/tier_3
...
/datum/persistent_option/portal/number_value/permit/gun/tier_4
...
/datum/persistent_option/portal/number_value/permit/gun/tier_5
...
/datum/persistent_option/portal/number_value/permit/production/cannabis
	name = "Cannabis Retail License"
	description = "Allows you to set the price of cannabis production licenses."
	id = "retail_production_cannabis"
	value = 800

/datum/persistent_option/portal/number_value/permit/production/tobacco
	name = "Tobacco Retail License"
	description = "Allows you to set the price of tobacco production licenses."
	id = "retail_production_cannabis"
	value = 400

/datum/persistent_option/portal/number_value/permit/production/alcohol
	name = "Alcohol Retail License"
	description = "Allows you to set the price of alcohol production licenses."
	id = "retail_production_alcohol"
	value = 400

/datum/persistent_option/portal/number_value/permit/production/firearms
	name = "Firearms Retail License"
