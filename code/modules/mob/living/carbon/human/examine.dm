/mob/living/carbon/human/examine(mob/user)
	...
	if(ssd_msg && (!should_have_organ("brain") || has_brain()) && stat != DEAD)
		if(!key)
			msg += "<span class='deadsay'>[T.He] [T.is] [ssd_msg]. The classical symptoms of Space Sleep Disorder (SSD). It doesn't look like [T.he] [T.is] waking up anytime soon.</span><br>"
		else if(!client)
			msg += "<span class='deadsay'>[T.He] [T.is] [ssd_msg]. The classical symptoms of Space Sleep Disorder (SSD).</span><br>"
