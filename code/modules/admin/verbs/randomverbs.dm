...
/client/proc/cmd_admin_add_random_ai_law()
	...
	if(show_log == "Yes")
		command_announcement.Announce("Ion storm detected near the city. Please check all AI-controlled equipment for errors.", "Anomaly Alert", new_sound = 'sound/AI/ionstorm.ogg')
