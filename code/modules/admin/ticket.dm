...
/datum/ticket/proc/close(var/datum/client_lite/closed_by)
	...
	message_admins("<span class='notice'><b>[src.owner.key_name(0)]</b>'s ticket has been closed by <b>[closed_by.key_name(0)]</b>.</span>")
...
/datum/ticket/proc/take(var/datum/client_lite/assigned_admin)
	...
	message_admins("<span class='notice'><b>[assigned_admin.key_name(0)]</b> has assigned themself to <b>[src.owner.key_name(0)]'s</b> ticket.</span>")
