...
/obj/item/weapon/deck/cah/black/card_text_list = list(
	...
	"The factory ordered a crate full of _____.",
	"An PDF was called due to ______.",
	"Alert! The Mayor has armed themselves with _____.",
	...
	"I think the Mayor is insane. He just demanded ______ in his office.",
	...
	"It is common practice for _______ to ______ in the Sol System.",
	...
	"Why did the synth cross the road?"
	)