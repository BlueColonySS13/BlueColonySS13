...
/obj/structure/closet/crate/secure/loot/proc/generate_loot()
	...
	switch(loot)
		if(1 to 5) // Common things go, 5%
			...
			new/obj/item/weapon/reagent_containers/food/snacks/grown/cannabisdeus(src)
		if(6 to 10)
		...
		if(21 to 25)
			for(var/i = 0, i < 3, i++)
				/obj/item/weapon/reagent_containers/food/snacks/superbiteburger(src)
		if(26 to 30)
			for(var/i = 0, i < 3, i++)
				new/obj/item/weapon/reagent_containers/glass/beaker/noreact(src)
		if(31 to 35)
			spawn_money(rand(1000,5000), src)
		if(36 to 40)
			/obj/item/weapon/melee/baton/loaded(src)
		if(41 to 45)
		...
		if(51 to 52) // Uncommon, 2% each
			new/obj/item/weapon/gun/energy/poxball(src) // Gotta add Blood Sport Somewhere - Art
			...
			new/obj/item/weapon/melee/poxball(src)
		if(53 to 54)
		...
		if(60)
			new/obj/item/rig_module/power_sink(src)
			new/obj/item/rig_module/mounted/egun(src)
			new/obj/item/rig_module/device/drill(src)
			new/obj/item/rig_module/chem_dispenser(src)
			new/obj/item/rig_module/device/flash(src)
			new/obj/item/rig_module/sprinter(src)
		if(61 to 62)
			for(var/i = 0, i < 12, ++i)
		...
		if(65 to 66)
			...
			new/obj/item/toy/cultsword(src)
		if(67 to 68)
			var/t = rand(4,7)
			for(var/i = 0, i < t, ++i)
		...
		if(90)
			new/obj/item/weapon/rig/light(src) // Re-Added, Only way to obtain - Art
			new/obj/item/rig_module/sprinter(src)
		if(91)
		    for(var/i = 0, i < 12, ++i)
		...
		if(97)
			new/obj/item/weapon/storage/belt/holding(src)
		if(98)
			new/obj/item/weapon/melee/energy/sword(src)
		if(99)
			new/obj/item/weapon/storage/belt/utility/alien/full
