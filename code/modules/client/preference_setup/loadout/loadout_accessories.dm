...
/datum/gear/accessory/brown_vest
	...
	allowed_roles = list("Station Engineer","Firefighter","Chief Engineer","Police Officer","Detective","Chief of Police","Prison Warden","Paramedic","Chief Medical Officer","Physician")
