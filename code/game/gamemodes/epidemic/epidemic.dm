/datum/game_mode/epidemic
	...
	round_description = "A deadly epidemic is spreading in the city. Find a cure as fast as possible, and keep your distance to anyone who speaks in a hoarse voice!"
...
/datum/game_mode/epidemic/pre_setup()
	...
	for(var/mob/new_player/player in world)
		if(player.mind.assigned_role in list("Chief Medical Officer","Doctor"))
			doctors++
			break
...
/datum/game_mode/epidemic/send_intercept()
	...
	intercepttext += "<B>* ELIMINATE THREAT WITH EXTREME PREJUDICE. [virus_name] IS HIGHLY CONTAGIOUS. INFECTED RESIDENTS MUST BE QUARANTINED IMMEDIATELY.</B><BR>"
	...
	intercepttext += "<B>* The existence of [virus_name] is highly confidential. To prevent a panic, only high-ranking City Council members are authorized to know of its existence. Residents that illegally obtained knowledge of [virus_name] are to be neutralized.</B><BR>"
