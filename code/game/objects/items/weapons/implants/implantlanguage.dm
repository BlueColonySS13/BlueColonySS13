...
<b>Function:</b> Allows a being otherwise incapable of speaking Galactic Common produce the phonemes of the language.<BR>
...
<HR>
<b>Implant Details:</b><BR>
<b>Function:</b> Allows a being otherwise incapable of speaking Skrellian to produce the phonemes of the language.<BR><b>Special Features:</b> None.<BR>
<b>Integrity:</b> Implant will function for expected life, barring physical damage."}
	return dat