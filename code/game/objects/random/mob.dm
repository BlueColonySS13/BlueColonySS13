...
/obj/random/mob/sewer/item_to_spawn()
	return pick(
				prob(15);/mob/living/simple_mob/animal/passive/crab/green,
				prob(15);/mob/living/simple_mob/animal/passive/cat,
				prob(60);/mob/living/simple_mob/animal/passive/mouse,
				prob(5);/mob/living/simple_mob/animal/sif/hooligan_crab,
				prob(5);/mob/living/simple_mob/animal/giant_spider/hunter
				)
...
/obj/random/mob/mouse/item_to_spawn()
	return pick(prob(30);/mob/living/simple_mob/animal/passive/mouse/white,
				prob(35);/mob/living/simple_mob/animal/passive/mouse/brown,
				prob(35);/mob/living/simple_mob/animal/passive/mouse/gray)
