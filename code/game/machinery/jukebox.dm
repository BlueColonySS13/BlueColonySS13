...
/obj/machinery/media/jukebox
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Telephone Number", 'sound/music/disco/Telephone Number (1984).ogg'),
	...
	var/list/datum/track/secret_tracks = list(
		...
		new/datum/track("Table", 'sound/music/disco/Chop Suey.ogg'),
		new/datum/track("Ievan Polkka", 'sound/music/disco/Ievan Polkka.ogg'),
