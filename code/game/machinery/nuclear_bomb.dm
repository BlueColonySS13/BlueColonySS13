...
/obj/machinery/nuclearbomb/proc/explode()
	...
	if(ticker)
		...
		if(ticker.mode)
			...
			world << "<B>The city was destoyed by the nuclear blast!</B>"

			ticker.mode.station_was_nuked = (off_station<2)	//offstation==1 is a draw. the city becomes irradiated and needs to be evacuated.
