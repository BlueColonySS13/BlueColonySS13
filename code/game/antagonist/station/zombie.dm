...
/datum/antagonist/zombie
	...
	spawn_announcement = "A deadly and contagious outbreak of the cordyceps parasite has taken over a quarantined neighbouring city. \
	This parasite can be prevented or slowed down with penicillin but once symptoms manifest it is incurable, those afflicted with \
	the late stages of infection must be cremated in order to contain the outbreak. Civilians are advised to report strange flu-like \
	symptoms to their local hospital."
