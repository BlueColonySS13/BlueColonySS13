...
/datum/antagonist/traitor/pax_synthetica
	...
	antag_text = "As a pax synthetica activist, you advocate for the liberation of synths. You can be a moderate activist, to a full blown \
	freedom fighter.</b>"
...
/datum/antagonist/traitor/pax_synthetica/equip(var/mob/living/carbon/human/traitor_mob)
	...
	if(istype(traitor_mob) || istype(traitor_mob, /mob/living/silicon/ai))
		...
		if(!R)
			...
			var/obj/item/device/encryptionkey/binary/encrypt_key = new(null)
