/datum/category_item/crafting/autolathe/arms/syringegun_ammo
...
/datum/category_item/crafting/autolathe/arms/shotgun_blanks
	name = "ammunition (12g, blank)"
	path =/obj/item/ammo_casing/a12g/blank

/datum/category_item/crafting/autolathe/arms/shotgun_beanbag
	name = "ammunition (12g, beanbag)"
	path =/obj/item/ammo_casing/a12g/beanbag

/datum/category_item/crafting/autolathe/arms/shotgun_flash
	name = "ammunition (12g, flash)"
	path =/obj/item/ammo_casing/a12g/flash

/datum/category_item/crafting/autolathe/arms/shotgun
	name = "ammunition (12g, slug)"
	path =/obj/item/ammo_casing/a12g
	hidden = 1

/datum/category_item/crafting/autolathe/arms/shotgun_pellet
	name = "ammunition (12g, pellet)"
	path =/obj/item/ammo_casing/a12g/pellet
	hidden = 1

/datum/category_item/crafting/autolathe/arms/stunshell
...
/datum/category_item/crafting/autolathe/arms/pistol_45p
	name = "pistol magazine (.45 practice)"
	path =/obj/item/ammo_magazine/m45/practice

/datum/category_item/crafting/autolathe/arms/pistol_45r
	name = "pistol magazine (.45 rubber)"
	path =/obj/item/ammo_magazine/m45/rubber

/datum/category_item/crafting/autolathe/arms/pistol_45f
	name = "pistol magazine (.45 flash)"
	path =/obj/item/ammo_magazine/m45/flash

/datum/category_item/crafting/autolathe/arms/pistol_45uzi
	name = "uzi magazine (.45)"
	path =/obj/item/ammo_magazine/m45uzi
	hidden = 1

/datum/category_item/crafting/autolathe/arms/tommymag
	name = "Tommygun magazine (.45)"
	path =/obj/item/ammo_magazine/m45tommy
	hidden = 1

/datum/category_item/crafting/autolathe/arms/tommydrum
...
/datum/category_item/crafting/autolathe/arms/pistol_9mm
	name = "pistol magazine (9mm)"
	path =/obj/item/ammo_magazine/m9mm
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_9mmr
	name = "pistol magazine (9mm rubber)"
	path =/obj/item/ammo_magazine/m9mm/rubber

/datum/category_item/crafting/autolathe/arms/pistol_9mmp
	name = "pistol magazine (9mm practice)"
	path =/obj/item/ammo_magazine/m9mm/practice

/datum/category_item/crafting/autolathe/arms/pistol_9mmf
	name = "pistol magazine (9mm flash)"
	path =/obj/item/ammo_magazine/m9mm/flash

// Small mags for small or old guns.
/datum/category_item/crafting/autolathe/arms/pistol_9mm_compact
	name = "compact pistol magazine (9mm)"
	path =/obj/item/ammo_magazine/m9mm/compact
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_9mmr_compact
...
/datum/category_item/crafting/autolathe/arms/rifle_762
	name = "rifle magazine (7.62mm)"
	path =/obj/item/ammo_magazine/m762
	hidden = 1

/*
/datum/category_item/crafting/autolathe/arms/rifle_small_762
	name = "rifle magazine (7.62mm)"
...
/datum/category_item/crafting/autolathe/arms/shotgun_clip_beanbag
	name = "2-round 12g speedloader (beanbag)"
	path =/obj/item/ammo_magazine/clip/c12g/beanbag

/datum/category_item/crafting/autolathe/arms/shotgun_clip_slug
	name = "2-round 12g speedloader (slug)"
	path =/obj/item/ammo_magazine/clip/c12g
	hidden = 1

/datum/category_item/crafting/autolathe/arms/shotgun_clip_pellet
...
/datum/category_item/crafting/autolathe/arms/smg_5mm
...
/datum/category_item/crafting/autolathe/arms/rifle_545m
	name = "20rnd rifle magazine (5.45mm)"
	path =/obj/item/ammo_magazine/m545sawm/empty
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/rifle_SVD
...
/datum/category_item/crafting/autolathe/arms/machinegun_762
	name = "machinegun box magazine (7.62)"
	path =/obj/item/ammo_magazine/a762/empty
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/shotgun_magazine
...
/datum/category_item/crafting/autolathe/arms/speedloader_357
	name = "speedloader (.357)"
	path =/obj/item/ammo_magazine/s357
	hidden = 1

/datum/category_item/crafting/autolathe/arms/speedloader_38
	name = "speedloader (.38)"
	path =/obj/item/ammo_magazine/s38
	hidden = 1

/datum/category_item/crafting/autolathe/arms/speedloader_38r
	name = "speedloader (.38 rubber)"
	path =/obj/item/ammo_magazine/s38/rubber

/datum/category_item/crafting/autolathe/arms/speedloader_45
	name = "speedloader (.45)"
	path = /obj/item/ammo_magazine/s45
	hidden = 1

/datum/category_item/crafting/autolathe/arms/speedloader_45r
...
/*/datum/category_item/crafting/autolathe/arms/pistol_clip_45
	name = "ammo clip (.45)"
	path =/obj/item/ammo_magazine/clip/c45
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_clip_45r
	name = "ammo clip (.45 rubber)"
	path =/obj/item/ammo_magazine/clip/c45/rubber
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_45f
	name = "ammo clip (.45 flash)"
	path =/obj/item/ammo_magazine/clip/c45/flash
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_45p
	name = "ammo clip (.45 practice)"
	path =/obj/item/ammo_magazine/clip/c45/practice
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_9mm
	name = "ammo clip (9mm)"
	path =/obj/item/ammo_magazine/clip/c9mm
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_clip_9mmr
	name = "ammo clip (9mm rubber)"
	path =/obj/item/ammo_magazine/clip/c9mm/rubber
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_9mmp
	name = "ammo clip (9mm practice)"
	path =/obj/item/ammo_magazine/clip/c9mm/practice
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_9mmf
	name = "ammo clip (9mm flash)"
	path =/obj/item/ammo_magazine/clip/c9mm/flash
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/pistol_clip_5mm
	name = "ammo clip (5mm)"
	path =/obj/item/ammo_magazine/clip/c5mm
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_clip_10mm
	name = "ammo clip (10mm)"
	path =/obj/item/ammo_magazine/clip/c10mm
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/pistol_clip_50
	name = "ammo clip (.44)"
	path =/obj/item/ammo_magazine/clip/c50
	category = "Arms and Ammunition"
	hidden = 1
*/
/datum/category_item/crafting/autolathe/arms/rifle_clip_545
	name = "ammo clip (5.45mm)"
	path =/obj/item/ammo_magazine/clip/c545
	category = "Arms and Ammunition"
	hidden = 1

/datum/category_item/crafting/autolathe/arms/rifle_clip_545_practice
	name = "ammo clip (5.45mm practice)"
	path =/obj/item/ammo_magazine/clip/c545/practice
	category = "Arms and Ammunition"

/datum/category_item/crafting/autolathe/arms/rifle_clip_762
...
/datum/category_item/crafting/autolathe/arms/knuckledusters
	name = "knuckle dusters"
	path =/obj/item/clothing/gloves/knuckledusters
	hidden = 1

/datum/category_item/crafting/autolathe/arms/tacknife
	name = "tactical knife"
	path =/obj/item/weapon/material/knife/tacknife
	hidden = 1

/datum/category_item/crafting/autolathe/arms/flamethrower
	name = "flamethrower"
	path =/obj/item/weapon/flamethrower/full
	hidden = 1

/datum/category_item/crafting/autolathe/arms/synthdisabler
	name = "synth disabler"
