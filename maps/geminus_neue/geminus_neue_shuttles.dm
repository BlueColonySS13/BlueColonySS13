...
/datum/shuttle/multi_shuttle/skipjack/New()
	...
	departure_message = "Attention.  Unidentified object exiting local space.  Unidentified object expected to escape Pollux gravity well with current velocity."
	..()

//PDF
/datum/shuttle/ferry/multidock/specops/ert
	name = "Pollux Defense Force Shuttle"
	location = 0
	warmup_time = 10
